...
{
	S_SM_ENUM_AUX_V(SM_IS, struct SMapIS, m, i, n->v, ss_void);
}
...
{
	S_SM_ENUM_AUX_K(struct SMapS, m, i, n->k, ss_void);
}
...
{
	S_SM_ENUM_AUX_V(SM_SS, struct SMapSS, m, i, n->v, ss_void);
}
