...
int32_t sc_tolower(int32_t c)
{
	...
	case 5: /* < 0x1fb8 */
		if (c < 0x531) {
			...
			if (c < 0x13f0) {
				...
				RR(c, 0x1cbd, 0x1cbf, c - 0xbc0);
				RR(c, 0x1c90, 0x1cba, c - 0xbc0);
		...
		if (c < 0xa640) {
			...
			if (c < 0xa7aa) {
				...
				if (c < 0xa7b4) {
					...
					RRE(c, 0xa7b8, 0xa7c2, c + 1);
					RE(c, 0xa7c4, 0xa794);
					RE(c, 0xa7c5, 0x282);
					RE(c, 0xa7c6, 0x1d8e);
					RRO(c, 0xa7c7, 0xa7c9, c + 1);
					RE(c, 0xa7d0, 0xa7d1);
					RRE(c, 0xa7d6, 0xa7d8, c + 1);
					RE(c, 0xa7f5, 0xa7f6);
	...
	case 8: /* >= 0x10428 */
		...
		RR(c, 0x10570, 0x1057a, c + 0x27);
		RR(c, 0x1057c, 0x1058a, c + 0x27);
		RR(c, 0x1058c, 0x10592, c + 0x27);
		RR(c, 0x10594, 0x10595, c + 0x27);
		RR(c, 0x10c80, 0x10cb2, c + 0x40);
		RR(c, 0x118a0, 0x118bf, c + 0x20);
		RR(c, 0x16e40, 0x16e5f, c + 0x20);
...
int32_t sc_toupper(int32_t c)
{
	...
	case 5: /* < 0x1ea1 */
		...
		RR(c, 0x10d0, 0x10fa, c + 0xbc0);
		RR(c, 0x10fd, 0x10ff, c + 0xbc0);
		...
		if (c < 0x2d27) {
			...
			if (c < 0xa791) {
				...
				if (c < 0xab70) {
					...
					RRO(c, 0xa7b9, 0xa7c3, c - 1);
					RRE(c, 0xa7c8, 0xa7ca, c - 1);
					RE(c, 0xa7d1, c - 1);
					RRO(c, 0xa7d7, 0xa7d9, c - 1);
					RE(c, 0xa7f6, c - 1);
					RE(c, 0xab53, 0xa7b3);
				} else {
	...
	case 8: /* >= 0x10450 */
		...
		RR(c, 0x10597, 0x105a1, c - 0x27);
		RR(c, 0x105a3, 0x105b1, c - 0x27);
		RR(c, 0x105b3, 0x105b9, c - 0x27);
		RR(c, 0x105bb, 0x105bc, c - 0x27);
		RR(c, 0x10cc0, 0x10cf2, c - 0x40);
		RR(c, 0x118c0, 0x118df, c - 0x20);
		RR(c, 0x16e60, 0x16e7f, c - 0x20);
