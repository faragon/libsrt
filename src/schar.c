...
int32_t sc_tolower(const int32_t c)
{
	...
	case 7:	if (c < 0x2c00) {
			...
			RR(c, 0x2160, 0x216f, c + 0x10); RE(c, 0x2183, 0x2184);
		...
		RE(c, 0x2c6f, 0x250); RE(c, 0x2c72, 0x2c73);
		RE(c, 0x2c75, 0x2c76); RR(c, 0x2c80, 0x2ce2, c + !(c % 2));
...
int32_t sc_toupper(const int32_t c)
{
	...
	case 2: if (c < 0x1f5) {
		...
		RE(c, 0x259, 0x18f); RE(c, 0x25b, 0x190);
		return c;
	case 3: if (c < 0x26f) {
			RE(c, 0x260, 0x193); RE(c, 0x263, 0x194);
			RE(c, 0x268, 0x197); RE(c, 0x269, 0x196);
			RE(c, 0x26b, 0x2c62);
			return c;
		} else if (c < 0x280) {
			...
			RE(c, 0x288, 0x1ae); RE(c, 0x289, 0x244);
			RE(c, 0x28a, 0x1b1);
			return c;
		}
	...
	case 4: if (c < 0x3ad) {
		...
		RE(c, 0x3d0, 0x392); RE(c, 0x3d1, 0x398); RE(c, 0x3d5, 0x3a6);
	...
	case 5: if (c < 0x3f8) {
		...
		RE(c, 0x1d7d, 0x2c63); RR(c, 0x1e01, 0x1e95, c - (c % 2));
		RE(c, 0x1e9b, 0x1e60);
		return c;
	case 6: if (c < 0x1f40) {
		...
		return c;
	case 7: if (c < 0x1fd1) {
			RR(c, 0x1fb0, 0x1fb1, c + 8); RE(c, 0x1fb3, 0x1fbc);
			...
			RE(c, 0x214e, 0x2132); RR(c, 0x2170, 0x217f, c - 0x10);
			RE(c, 0x2184, 0x2183); RR(c, 0x24d0, 0x24e9, c - 0x1a);
			...
			RE(c, 0x2c6c, 0x2c6b); RE(c, 0x2c73, 0x2c72);
			RE(c, 0x2c76, 0x2c75);
