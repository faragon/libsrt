...
TEST_FLAGS[12]="C99=0"
TEST_FLAGS[13]="C99=1"
TEST_FLAGS[14]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DS_DISABLE_SM_STRING_OPTIMIZATION"
TEST_FLAGS[15]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DS_CRC32_SLC=0"
TEST_FLAGS[16]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DS_CRC32_SLC=1"
TEST_FLAGS[17]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DS_CRC32_SLC=4"
TEST_FLAGS[18]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DS_CRC32_SLC=8"
TEST_FLAGS[19]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DS_CRC32_SLC=12"
TEST_FLAGS[20]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DS_CRC32_SLC=16"
TEST_FLAGS[21]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DSD_DISABLE_HEURISTIC_GROWTH"
TEST_FLAGS[22]=${TEST_FLAGS[0]}" ADD_CFLAGS=-DSLZW_ENABLE_RLE=0"
TEST_DO_UT[0]="all"
TEST_DO_UT[1]="all"
TEST_DO_UT[2]="all"
TEST_DO_UT[3]="all"
...
VALGRIND_LOOP_FLAGS[1]="DEBUG=1 ADD_CFLAGS=-DS_DISABLE_SM_STRING_OPTIMIZATION"
VALGRIND_LOOP_FLAGS[2]="MINIMAL=1 DEBUG=1"
VALGRIND_LOOP_FLAGS[3]="MINIMAL=1 DEBUG=1"
VALGRIND_LOOP_FLAGS[3]+=" ADD_CFLAGS=-DS_DISABLE_SM_STRING_OPTIMIZATION"
ERRORS=0
NPROCS=0
MJOBS=1
